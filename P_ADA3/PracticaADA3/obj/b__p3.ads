...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_p3" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#dcadfa35#;
   pragma Export (C, u00001, "p3B");
   ...
   u00102 : constant Version_32 := 16#04ac13c8#;
   pragma Export (C, u00102, "controladorB");
   u00103 : constant Version_32 := 16#b06a63a3#;
   ...
   u00158 : constant Version_32 := 16#63436fa1#;
   pragma Export (C, u00158, "system__concat_4S");
   u00159 : constant Version_32 := 16#9d39c675#;
   pragma Export (C, u00159, "system__memoryB");
   u00160 : constant Version_32 := 16#445a22b5#;
