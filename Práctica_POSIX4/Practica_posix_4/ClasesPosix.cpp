...
int hilo_t::EstablecerAtributos(int prioridad, int politica,int herecia, int periodo_rep, int tiempo_exec_tperiodica,
                                struct timespec tiempo_comienzo_tarea) {
...
La implementación de la clase mutex_t hay que mantenerla sin modificar
*/
